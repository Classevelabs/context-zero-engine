...
function getGrammar(language: SupportedLanguage): TreeSitterLanguage {
  ...
  try {
    ...
    throw new Error(
      `Failed to load grammar for ${language}: ${err instanceof Error ? err.message : String(err)}. The tree-sitter grammar package may need to be rebuilt for your platform.`,
    )
  }
...
const BEHAVIOR_PATTERNS: BehaviorPattern[] = [
  ...
  {
    pattern: /\.(findOne|findMany|findAll|findById|findUnique|findFirst)\s*\(/,
    hint_type: "db_read",
    detail: "orm_find",
  },
  ...
  {
    pattern:
      /\b(db|DB|repo|repository|model|Model|collection|Collection|table|Table)\.\w*(save|insert|update|delete|remove|create|upsert|destroy)\w*\s*\(/,
    hint_type: "db_write",
  ...
  {
    pattern: /reqwest::(get|post|put|patch|delete|Client)/,
    hint_type: "network_call",
    detail: "reqwest",
    languages: ["rust"],
  },
  ...
  {
    pattern: /tracing::(debug|info|warn|error|trace|span)/,
    hint_type: "logging",
    detail: "rust_tracing",
    languages: ["rust"],
  },
  ...
  {
    pattern: /Files\.(read|write|copy|move|delete|create)/,
    hint_type: "file_io",
    detail: "java_nio_files",
    languages: ["java"],
  },
  {
    pattern: /FileInputStream|FileOutputStream|FileReader|FileWriter/,
    hint_type: "file_io",
    detail: "java_file_io",
    languages: ["java"],
  },
  ...
  {
    pattern: /Logger\.(debug|info|warn|error|trace)/,
    hint_type: "logging",
    detail: "java_logger",
    languages: ["java"],
  },
  ...
  {
    pattern: /HttpClient\.(Get|Post|Put|Delete|Send)/,
    hint_type: "network_call",
    detail: "csharp_httpclient",
    languages: ["csharp"],
  },
  {
    pattern: /WebRequest|HttpWebRequest/,
    hint_type: "network_call",
    detail: "csharp_webrequest",
    languages: ["csharp"],
  },
  {
    pattern: /File\.(Read|Write|Open|Create|Delete|Copy|Move)/,
    hint_type: "file_io",
    detail: "csharp_file",
    languages: ["csharp"],
  },
  ...
  {
    pattern: /SemaphoreSlim|Monitor\.(Enter|Exit)/,
    hint_type: "acquires_lock",
    detail: "csharp_semaphore",
    languages: ["csharp"],
  },
  {
    pattern: /ILogger\.(Log|Debug|Info|Warn|Error)/,
    hint_type: "logging",
    detail: "csharp_ilogger",
    languages: ["csharp"],
  },
  ...
  {
    pattern: /std::mutex|std::lock_guard|std::unique_lock/,
    hint_type: "acquires_lock",
    detail: "cpp_mutex",
    languages: ["cpp"],
  },
  {
    pattern: /std::(i|o)?fstream|std::ifstream|std::ofstream/,
    hint_type: "file_io",
    detail: "cpp_fstream",
    languages: ["cpp"],
  },
  ...
  {
    pattern: /asyncio\.(run|gather|create_task|ensure_future)/,
    hint_type: "concurrency",
    detail: "python_asyncio",
    languages: ["python"],
  },
  {
    pattern: /aiohttp\.(ClientSession|request)/,
    hint_type: "network_call",
    detail: "python_aiohttp",
    languages: ["python"],
  },
  ...
  {
    pattern: /httpx\.(get|post|put|delete|AsyncClient)/,
    hint_type: "network_call",
    detail: "python_httpx",
    languages: ["python"],
  },
  ...
  {
    pattern: /\b(launch|async|runBlocking|withContext|Dispatchers)\b/,
    hint_type: "concurrency",
    detail: "kotlin_coroutine",
    languages: ["kotlin"],
  },
  {
    pattern: /\bRetrofit|OkHttpClient|HttpClient\b/,
    hint_type: "network_call",
    detail: "kotlin_http",
    languages: ["kotlin"],
  },
  {
    pattern: /\b(Room|Exposed|Hibernate|JpaRepository)\b/,
    hint_type: "db_read",
    detail: "kotlin_orm",
    languages: ["kotlin"],
  },
  {
    pattern: /\bFile\.(readText|writeText|readLines|readBytes)\b/,
    hint_type: "file_io",
    detail: "kotlin_file",
    languages: ["kotlin"],
  },
  ...
  {
    pattern: /\bTask\s*\{|async\s+let\b/,
    hint_type: "concurrency",
    detail: "swift_structured_concurrency",
    languages: ["swift"],
  },
  {
    pattern: /\bURLSession\.(shared|data|download|upload)\b/,
    hint_type: "network_call",
    detail: "swift_urlsession",
    languages: ["swift"],
  },
  { pattern: /\bAlamofire\b/, hint_type: "network_call", detail: "swift_alamofire", languages: ["swift"] },
  {
    pattern: /\bCoreData|NSManagedObject|NSPersistentContainer\b/,
    hint_type: "db_read",
    detail: "swift_coredata",
    languages: ["swift"],
  },
  {
    pattern: /\bFileManager\.(default|copyItem|moveItem|removeItem|createFile)\b/,
    hint_type: "file_io",
    detail: "swift_filemanager",
    languages: ["swift"],
  },
  { pattern: /\bUserDefaults\b/, hint_type: "cache_op", detail: "swift_userdefaults", languages: ["swift"] },
  {
    pattern: /\bos_unfair_lock|NSLock|DispatchSemaphore\b/,
    hint_type: "acquires_lock",
    detail: "swift_lock",
    languages: ["swift"],
  },
  ...
  {
    pattern: /\bEloquent|DB::table|DB::select|Model::(find|where|all)\b/,
    hint_type: "db_read",
    detail: "php_eloquent",
    languages: ["php"],
  },
  {
    pattern: /\b(->save|->create|->update|->delete|->destroy)\s*\(/,
    hint_type: "db_write",
    detail: "php_eloquent_write",
    languages: ["php"],
  },
  {
    pattern: /\bcurl_init|Guzzle|Http::get|Http::post\b/,
    hint_type: "network_call",
    detail: "php_http",
    languages: ["php"],
  },
  {
    pattern: /\b(fopen|fwrite|fread|file_get_contents|file_put_contents)\b/,
    hint_type: "file_io",
    detail: "php_file",
    languages: ["php"],
  },
  ...
  {
    pattern: /\bAuth::(check|user|attempt|login|logout)\b/,
    hint_type: "auth_check",
    detail: "php_auth",
    languages: ["php"],
  },
  {
    pattern: /\bDB::beginTransaction|DB::commit|DB::rollBack\b/,
    hint_type: "transaction",
    detail: "php_transaction",
    languages: ["php"],
  },
  {
    pattern: /\bLog::(info|debug|warning|error|critical)\b/,
    hint_type: "logging",
    detail: "php_log",
    languages: ["php"],
  },
...
function getNodeName(node: SyntaxNode, language: SupportedLanguage): string | null {
  ...
  if (nameChild) {
    ...
    if (
      nameChild.type === "identifier" ||
      nameChild.type === "type_identifier" ||
      nameChild.type === "field_identifier" ||
      nameChild.type === "property_identifier"
    ) {
...
function extractLeadingComment(node: SyntaxNode, source: string): string | undefined {
  ...
  const startByte = node.parent?.type === "export_statement" ? node.parent.startIndex : node.startIndex
  ...
  switch (language) {
    ...
    case "java": {
      ...
      if (throwsClauseText && throwsClauseText[1]) {
        const types = throwsClauseText[1]
          .split(",")
          .map((t: string) => t.trim())
          .filter(Boolean)
...
function walkForRelations(
  ...
  if (type === "type_identifier" || type === "generic_type") {
    const typeName = type === "generic_type" ? node.namedChild(0)?.text || node.text : node.text
  ...
  switch (language) {
    ...
    case "ruby": {
      ...
      for (const callNode of calls) {
        ...
        if (
          methodNode &&
          (methodNode.text === "include" || methodNode.text === "extend" || methodNode.text === "prepend")
        ) {
          const args = callNode.childForFieldName("arguments")
          if (args) {
                ...
                relations.push({
                  ...
                  relation_type:
                    methodNode.text === "include"
                      ...
                      : ("imports" as StructuralRelationType),
                })
              }
            }
          }
      ...
      if (node.type === "class_specifier" || node.type === "struct_specifier") {
        ...
        for (const clause of baseClauses) {
          for (let i = 0; i < clause.namedChildCount; i++) {
            ...
            const typeId =
              findDescendantByType(child, "type_identifier") || findDescendantByType(child, "qualified_identifier")
            if (typeId) {
              relations.push({
                source_key: stableKey,
        ...
        if (baseList) {
          for (let i = 0; i < baseList.namedChildCount; i++) {
            ...
            if (base) {
              ...
              const relType =
                node.type === "interface_declaration" || i > 0
...
const PYTHON_SYMBOL_TYPES = new Set(["function_definition", "class_definition", "decorated_definition"])
...
const RUBY_SYMBOL_TYPES = new Set(["method", "singleton_method", "class", "module"])
...
const BASH_SYMBOL_TYPES = new Set(["function_definition"])
...
function walkNode(
  ...
  if (lang === "go") {
    ...
    if (nodeType === "const_declaration" || nodeType === "var_declaration") {
      ...
      const specs = node.descendantsOfType(nodeType === "const_declaration" ? "const_spec" : "var_spec")
      if (specs.length > 0) {
  ...
  if (lang === "rust") {
    ...
    if (nodeType === "impl_item") {
      ...
      const body = node.childForFieldName("body")
      if (body) {
        const implParentName = traitNode ? `${implName}(${traitNode.text})` : implName
        for (let i = 0; i < body.namedChildCount; i++) {
          const member = body.namedChild(i)
...
export class UniversalAdapter {
   ...
   */
  public extract(filePath: string, source: string, language: SupportedLanguage): AdapterExtractionResult {
